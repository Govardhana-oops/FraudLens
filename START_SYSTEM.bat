...
:: Start Officer Web Console on Port 5174 in a dedicated window
echo - Starting FraudLens Web Console UI (Port 5174)...
start "FraudLens Web Console [Port 5174]" cmd /k "cd /d "%~dp0\fraudlens-new-frontend" && title FraudLens Web Console [Port 5174] && npm run dev -- --port 5174"
...
echo.
echo    * Web Console (UI):   http://localhost:5174
